...
<html>
    ...
    <body>
        <a class="header_logo" href="https://www.wdpro.it/" target="_blank">
            <img src="data:image/png;
                 ...
                 width="263" height="70" alt="WDP - The cloud-hosting control panel" border="0"></a>
        <div class="content">
            <h1><?php echo strtolower($_SERVER['HTTP_HOST']); ?></h1>
            <p>This domain is registered and is currently parked.... </p>
            <p>Thank you for using WDP to manage your hosting!</p>
            <p><b>For more information and help using WDP please visit:</b> <a href="https://www.wdpro.it/" target="_blank">www.wdpro.it</a>.</p>
            <p>Kind regards,<br>
                Your hosting company.</p>
        </div>
        <div class="poweredbox">
            <p><strong>Powered by <a href="https://www.wdpro.it/" target="_blank">WebDesignProduction</a></strong> - The cloud-hosting control panel.</p>
        </div>
    </body>
</html>
